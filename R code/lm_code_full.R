...
# check residuals plot of cat model
par(mfrow=c(1,2))
qqnorm(cat_model$residuals, pch=19, main=" ")
qqline(cat_model$residuals)
plot(cat_model$fitted.values, cat_model$residuals, pch=19, xlab="Fitted Values", ylab="Residuals")
abline(h=5, col="red")
